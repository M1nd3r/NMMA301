...
\end{lemma}
\fbox{Reimannova hypotéza} Je-li $z$ nulový bod funkce $\zeta$ v kritickém pásu, potom $\Rel(z)=\frac{1}{2}$. Jeden z nejslavnějších otevřených problémů v matematice (odměna j milion \$). Má úzkou souvislost s rozložením prvočísel, viz [RIEMANN, B.; On the Number of Prime Numbers less than a Given Quantity, 1859]
