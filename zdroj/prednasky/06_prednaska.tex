...
\begin{itemize}
    \item Definujeme \emph{stereografickou projekci} $\phi:\mathbb{C}\rightarrow S^2\setminus \{N\}$ jako na obrázku, kde $N=(0,\,0,\,1)$.
    $\includegraphics[width=\textwidth]{images/obrazek1.jpeg}$ 
    Položme $\phi(\infty):=N$. Pro $z\in\mathbb{C}$ je $\{\phi(z)\}=(S\setminus \{N\})\cap p_z$, kde $p_z$ je polopřímka z $N$ procházející bodem $z\in\mathbb{C}$. Potom $\phi:\Sp\xrightarrow[]{na}S^2$ je bijekce.
    \begin{excercise}
    \mbox{}
     \begin{itemize}
        \item[\textbullet] $\phi(z):=\left(\frac{2x}{x^2+y^2+1},\frac{2y}{x^2+y^2+1},\frac{x^2+y^2-1}{x^2+y^2+1}\right)$, $z=x+iy \in \mathbb{C}$.
     ...
     \end{itemize}
    \end{excercise}
    \item Položme $\varrho(z,\,w):=|\phi(z)-\phi(w)|$, $z,\,w\in\Sp$, kde $|\cdot|_S$ je eukleidovská norma  v $\mathbb{R}^3$. Potom $\phi$ je izometrie $(\Sp,\varrho)$ na $S^2$.
