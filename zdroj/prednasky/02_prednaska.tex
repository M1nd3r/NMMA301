...
\begin{itemize}    
    ...
    \item $\exp'(z)=\exp(z)$, $ z \in\mathbb{C}$
         ...
         $f(z)=\exp(z)\text{, }\newline f_1(x,y)=e^x \cos y\text{, }\newline f_2(x,y)=e^x\sin y\text{, }\newline
    ...
    a \cref{eqn:CR} platí všude v $\mathbb{R}^2\cong\mathbb{C}$. Z CR-věty a \textbf{ poznámky 3.7} máme $f'(z)=\exp(z)\text{, } z\in\mathbb{C}$
  ...
  \end{properties}
  \begin{definition}
    Nechť $z=x+iy$ je komplexní číslo, pak se na něj můžeme dívat jako na bod v rovině určený kartézskými souřadnicemi $x$ a $y$. \emph{Polární (Goniometrický) tvar komplexního čísla} získám tak, že si body $x$ a $y$ vyjádřím v polárních souřadnicích a ty pak dosadím do rovnice udávající $z$. Tedy
...
\begin{itemize}
    ...
    \item Nechť $\alpha\in\mathbb{Q}$ a $\alpha=p/q$, kde $q\in\mathbb{N}$, $p\in\mathbb{Z}$ a $p,q$ jsou nesoudělná. Potom $m_{\frac{p}{q}}(z)=\{z^{\frac{p}{q}}e^{\frac{2K\pi i p}{q}}\mid K=\{0,1,\cdots,q-1\}\}$
