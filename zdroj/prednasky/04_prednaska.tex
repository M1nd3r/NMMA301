...
$$
0<\frac{K}{4^j} \le \left| \int_{\varphi_j}f\right|\stackrel{\cref{eqn:b}}{=} \left|\int_{\varphi_j}\varepsilon(z)(z-z_0)\right| \le V^2(\varphi_j) \max_{<\varphi_j>}|\varepsilon|\overset{\cref{eqn:a}}{=}\frac{V^2(\varphi)}{4^j}\cdot \max_{<\varphi_j>}|\varepsilon| \text{,}
$$
...
\begin{proof}
Z Goursartova lemmatu a dodatku k větě o existenci PF (Dodatek 5.23).
\end{proof}
